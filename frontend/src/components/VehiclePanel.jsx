    ...
    <div>
        <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={() => {
            ...
            <h3 className='text-2xl font-semibold mb-3'>Choose a Vehicle</h3>
             ...
             className='flex border-2  border-gray-300 active:border-black mb-2 rounded-xl items-center justify-between p-3 cursor-pointer active:bg-zinc-300 hover:bg-zinc-200'>
                <img
                 className='h-12'
              ...
              className='flex border-2 border-gray-300 active:border-black mb-2 rounded-xl items-center justify-between p-3 cursor-pointer active:bg-zinc-300 hover:bg-zinc-200'>
                <img
                 ...
                 <div className='ml-2 w-1/2'> 
                  <h4 className='font-medium text-base'>UberGo <span><i className="ri-user-3-fill"></i>2</span></h4>
                  <h5 className='font-medium text-sm'>2  mins away</h5>
