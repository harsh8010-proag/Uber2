 ...
 const profileImage = user.profileImage?`${import.meta.env.VITE_BASE_URL}${user.profileImage}`: profileimg ;
  ...
  return (
    <div className='h-screen relative  overflow-hidden'>
      ...
      <Link to='/user-profile' className='absolute right-5 top-5 z-1 bg-white p-2 rounded-lg flex flex-col items-center hover:opacity-90 ml-5'>
    <img 
    ...
    <p className='text-sm  text-gray-900'>profile</p>
      ...
      <div className='flex flex-col justify-end h-full absolute top-0 w-full  '>
        ...
        <div className='h-[30%] p-6 bg-white relative z-2'>
      ...
      <div
        ...
        className='fixed w-full z-10 bottom-0 bg-zinc-200 px-3 py-6 '>
