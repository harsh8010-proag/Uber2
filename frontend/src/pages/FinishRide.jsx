  ...
  return (
        <div > 
            <h5 className='p-1 text-center w-[93%] absolute top-0'
                onClick={() => { props.setFinishRidePanel(false); }}><i className="text-3xl text-gray-200 ri-arrow-down-wide-line"></i></h5>
            ...
            <div className='flex gap-2 flex-col justify-between items-center'>
                ...
                <div className='w-full mt-5'>
                    ...
                    <button     
                        ...
                        className='w-full block text-center mt-5 bg-green-600 font-semibold p-3 rounded-lg text-white'>finish ride</button>
